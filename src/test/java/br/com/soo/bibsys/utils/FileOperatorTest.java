...
public class FileOperatorTest {
	...
	@Test public void fileToMapWithOneTagTest() {
	...
	@Test public void fileToMapWithTwoTagTest() {
		FileOperator comparator = new FileOperator();
	...
	@Test public void fileToMapTwoRefs() {
		FileOperator comparator = new FileOperator();
	...
	@Test public void fileToMapFourRefs() {
		FileOperator comparator = new FileOperator();
	...
	@Test public void orderFileTest() {
		FileOperator comparator = new FileOperator();
	...
	@Test public void mapToFileTest() {
		FileOperator comparator = new FileOperator();
